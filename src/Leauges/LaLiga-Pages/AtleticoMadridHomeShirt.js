...
import atleticoFront from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoHomeFront.png";
import atleticoBack from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoHomeBack.png";
import atleticoFrontSmall from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoHomeFrontSmall.png";
import atleticoBackSmall from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const AtleticoMadridHomeShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ATLETICO MADRID HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default AtleticoMadridHomeShirt;
