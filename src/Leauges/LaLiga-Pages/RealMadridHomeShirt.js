...
import realFront from "../leauges-asset/LaLiga/Real-Madrid/RealMadridHome.jpg";
import realFrontSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridHomeSmall.jpg";
import "../../Pages/ShirtSales.css";

const RealMadridHomeShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>REAL MADRID HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default RealMadridHomeShirt;
