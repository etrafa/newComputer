...
import barcelonaFront from "../leauges-asset/LaLiga/Barcelona/BarcelonaThirdFront.jpg";
import barcelonaBack from "../leauges-asset/LaLiga/Barcelona/BarcelonaThirdBack.jpg";
import barcelonaFrontSmall from "../leauges-asset/LaLiga/Barcelona/BarcelonaThirdFrontSmall.jpg";
import barcelonaBackSmall from "../leauges-asset/LaLiga/Barcelona/BarcelonaThirdBackSmall.jpg";
import "../../Pages/ShirtSales.css";

const BarcelonaThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={barcelonaFrontSmall}
          onClick={() => setImage(barcelonaFront)}
          alt=""
        />
        <img
          src={barcelonaBackSmall}
          onClick={() => setImage(barcelonaBack)}
          alt=""
        />
      </div>
      <h1>BARCELONA THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default BarcelonaThirdShirt;
