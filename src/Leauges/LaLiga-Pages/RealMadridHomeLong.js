...
import realFront from "../leauges-asset/LaLiga/Real-Madrid/RealMadridHomeLong.jpg";
import realFrontSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridHomeLongSmall.jpg";
import "../../Pages/ShirtSales.css";

const RealMadridHomeLong = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>REAL MADRID HOME LONG SLEEVE FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default RealMadridHomeLong;
