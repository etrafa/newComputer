...
import atleticoFront from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoAwayFront.png";
import atleticoBack from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoAwayBack.png";
import atleticoFrontSmall from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoAwayFrontSmall.png";
import atleticoBackSmall from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const AtleticoMadridAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ATLETICO MADRID AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default AtleticoMadridAwayShirt;
