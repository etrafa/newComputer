...
import atleticoFront from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoHomeShorts.jpg";
import atleticoFrontSmall from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoHomeShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const AtleticoMadridHomeShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ATLETICO MADRID HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
      <div className="shirtSales__price__container">
        <p className="shirtSales__price">$15.00</p>
...
export default AtleticoMadridHomeShorts;
