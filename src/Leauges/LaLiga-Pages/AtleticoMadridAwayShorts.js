...
import atleticoFront from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoAwayShorts.jpg";
import atleticoFrontSmall from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoAwayShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const AtleticoMadridAwayShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ATLETICO MADRID AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default AtleticoMadridAwayShorts;
