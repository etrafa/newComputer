...
import realFront from "../leauges-asset/LaLiga/Real-Madrid/RealMadridHomeKids.jpg";
import realFrontSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridHomeKidsSmall.jpg";
import "../../Pages/ShirtSales.css";

const RealMadridHomeKids = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>REAL MADRID HOME KIDS FOOTBALL KIT 21/22</h1>
      <hr />
...
export default RealMadridHomeKids;
