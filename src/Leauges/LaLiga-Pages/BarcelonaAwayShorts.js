...
import barcelonaFront from "../leauges-asset/LaLiga/Barcelona/BarcelonaAwayShorts.jpg";
import barcelonaFrontSmall from "../leauges-asset/LaLiga/Barcelona/BarcelonaAwayShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const BarcelonaAwayShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BARCELONA AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default BarcelonaAwayShorts;
