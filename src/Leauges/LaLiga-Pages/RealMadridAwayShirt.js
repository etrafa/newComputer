...
import realFront from "../leauges-asset/LaLiga/Real-Madrid/RealMadridAwayFront.png";
import realBack from "../leauges-asset/LaLiga/Real-Madrid/RealMadridAwayBack.png";
import realFrontSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridAwayFrontSmall.png";
import realBackSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const RealMadridAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>REAL MADRID AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default RealMadridAwayShirt;
