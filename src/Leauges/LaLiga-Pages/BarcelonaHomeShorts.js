...
import barcelonaFront from "../leauges-asset/LaLiga/Barcelona/BarcelonaHomeShorts.jpg";
import barcelonaFrontSmall from "../leauges-asset/LaLiga/Barcelona/BarcelonaHomeShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const BarcelonaHomeShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BARCELONA HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default BarcelonaHomeShorts;
