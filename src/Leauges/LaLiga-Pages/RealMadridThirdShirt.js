...
import realFront from "../leauges-asset/LaLiga/Real-Madrid/RealMadridThirdFront.jpg";
import realBack from "../leauges-asset/LaLiga/Real-Madrid/RealMadridThirdBack.jpg";
import realFrontSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridThirdFrontSmall.jpg";
import realBackSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridThirdBackSmall.jpg";
import "../../Pages/ShirtSales.css";

const RealMadridThirdShirt = () => {
  const [image, setImage] = useState(realFront);

  return (
    <div className="shirtSales__container">
      <img className="mainShirt__front" src={image} alt="" />
      <div className="mainShirt__small">
        <img src={realFrontSmall} onClick={() => setImage(realFront)} alt="" />
        <img src={realBackSmall} onClick={() => setImage(realBack)} alt="" />
      </div>
      <h1>REAL MADRID THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={realFront} alt="" />
          <img src={realBack} alt="" />
        </div>
      </div>
    </div>
  );
...
export default RealMadridThirdShirt;
