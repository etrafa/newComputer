...
import realFront from "../leauges-asset/LaLiga/Real-Madrid/RealMadridThirdShorts.jpg";
import realFrontSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridThirdShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const RealMadridThirdShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>REAL MADRID THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default RealMadridThirdShorts;
