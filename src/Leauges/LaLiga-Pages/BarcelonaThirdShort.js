...
import barcelonaFront from "../leauges-asset/LaLiga/Barcelona/BarcelonaThirdShorts.jpg";
import barcelonaFrontSmall from "../leauges-asset/LaLiga/Barcelona/BarcelonaThirdShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const BarcelonaThirdShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BARCELONA THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default BarcelonaThirdShorts;
