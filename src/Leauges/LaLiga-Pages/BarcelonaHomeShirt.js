...
import barcelonaFront from "../leauges-asset/LaLiga/Barcelona/BarcelonaHomeFront.png";
import barcelonaBack from "../leauges-asset/LaLiga/Barcelona/BarcelonaHomeBack.png";
import barcelonaFrontSmall from "../leauges-asset/LaLiga/Barcelona/BarcelonaHomeFrontSmall.png";
import barcelonaBackSmall from "../leauges-asset/LaLiga/Barcelona/BarcelonaHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const BarcelonaHomeShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BARCELONA HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default BarcelonaHomeShirt;
