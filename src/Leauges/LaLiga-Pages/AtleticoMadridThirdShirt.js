...
import atleticoFront from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoThirdFront.jpg";
import atleticoBack from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoThirdBack.png";
import atleticoFrontSmall from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoThirdFrontSmall.jpg";
import atleticoBackSmall from "../leauges-asset/LaLiga/Atletico-Madrid/AtleticoThirdBack.png";
import "../../Pages/ShirtSales.css";

const AtleticoMadridThirdShirt = () => {
  const [image, setImage] = useState(atleticoFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={atleticoFrontSmall}
          onClick={() => setImage(atleticoFront)}
          alt=""
        />
        <img
          src={atleticoBackSmall}
          onClick={() => setImage(atleticoBack)}
          alt=""
        />
      </div>
      <h1>ATLETICO MADRID THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={atleticoFront} alt="" />
          <img src={atleticoBack} alt="" />
        </div>
      </div>
    </div>
  );
...
export default AtleticoMadridThirdShirt;
