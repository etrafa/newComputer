...
import realFront from "../leauges-asset/LaLiga/Real-Madrid/RealMadridHomeShorts.jpg";
import realFrontSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridHomeShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const RealMadridHomeShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>REAL MADRID HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default RealMadridHomeShorts;
