...
import realFront from "../leauges-asset/LaLiga/Real-Madrid/RealMadridAwayShorts.jpg";
import realFrontSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridAwayShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const RealMadridAwayShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>REAL MADRID AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default RealMadridAwayShorts;
