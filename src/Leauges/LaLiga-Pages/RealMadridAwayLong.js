...
import realFront from "../leauges-asset/LaLiga/Real-Madrid/RealMadridAwayLong.png";
import realFrontSmall from "../leauges-asset/LaLiga/Real-Madrid/RealMadridAwayLongSmall.png";
import "../../Pages/ShirtSales.css";

const RealMadridAwayLong = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>REAL MADRID AWAY LONG SLEEVE FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default RealMadridAwayLong;
