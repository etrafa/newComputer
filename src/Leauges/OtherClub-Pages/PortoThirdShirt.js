...
import portoFront from "../leauges-asset/Other-Clubs/Porto/PortoThird.jpg";
import portoFrontSmall from "../leauges-asset/Other-Clubs/Porto/PortoThirdSmall.jpg";
import "../../Pages/ShirtSales.css";

const PortoThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>FC PORTO THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default PortoThirdShirt;
