...
import portoFront from "../leauges-asset/Other-Clubs/Porto/PortoAwayFront.jpg";
import portoBack from "../leauges-asset/Other-Clubs/Porto/PortoAwayBack.png";
import portoFrontSmall from "../leauges-asset/Other-Clubs/Porto/PortoAwayFrontSmall.jpg";
import portoBackSmall from "../leauges-asset/Other-Clubs/Porto/PortoAwayBackSmall.png";

import "../../Pages/ShirtSales.css";

const PortoAwayShirt = () => {
  const [image, setImage] = useState(portoFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={portoFrontSmall}
          onClick={() => setImage(portoFront)}
          alt=""
        />
        <img src={portoBackSmall} onClick={() => setImage(portoBack)} alt="" />
      </div>
      <h1>FC PORTO AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={portoFront} alt="" />
          <img src={portoBack} alt="" />
        </div>
      </div>
    </div>
  );
