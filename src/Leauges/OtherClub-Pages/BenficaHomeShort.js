...
import benficaFront from "../leauges-asset/Other-Clubs/Benfica/BenficaHomeShort.jpg";
import benficaFrontSmall from "../leauges-asset/Other-Clubs/Benfica/BenficaHomeShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const BenficaHomeShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BENFICA HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default BenficaHomeShort;
