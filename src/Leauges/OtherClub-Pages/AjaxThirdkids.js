...
import ajaxFront from "../leauges-asset/Other-Clubs/Ajax/AjaxThirdKids.jpg";
import ajaxFrontSmall from "../leauges-asset/Other-Clubs/Ajax/AjaxThirdKidsSmall.jpg";
...
const AjaxThirdKids = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>AJAX THIRD KIDS FOOTBALL KIT 21/22</h1>
      <hr />
