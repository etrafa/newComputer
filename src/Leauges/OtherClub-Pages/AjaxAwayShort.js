...
import ajaxFront from "../leauges-asset/Other-Clubs/Ajax/AjaxAwayShort.jpg";
import ajaxFrontSmall from "../leauges-asset/Other-Clubs/Ajax/AjaxAwayShortSmall.jpg";
...
const AjaxAwayShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>AJAX AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
