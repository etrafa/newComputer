...
import celticFront from "../leauges-asset/Other-Clubs/Celtic/CelticHome.jpg";
import celticFrontSmall from "../leauges-asset/Other-Clubs/Celtic/CelticHomeSmall.jpg";
import "../../Pages/ShirtSales.css";

const CelticHomeShirt = () => {
  const [image, setImage] = useState(celticFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={celticFrontSmall}
          onClick={() => setImage(celticFront)}
          alt=""
        />
      </div>
      <h1>CELTIC HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default CelticHomeShirt;
