...
import benficaFront from "../leauges-asset/Other-Clubs/Benfica/BenficaAwayShort.jpg";
import benficaFrontSmall from "../leauges-asset/Other-Clubs/Benfica/BenficaAwayShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const BenficaAwayShort = () => {
  const [image, setImage] = useState(benficaFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={benficaFrontSmall}
          onClick={() => setImage(benficaFront)}
          alt=""
        />
      </div>
      <h1>BENFICA AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default BenficaAwayShort;
