...
import ajaxFront from "../leauges-asset/Other-Clubs/Ajax/AjaxAway.jpg";
import ajaxFrontSmall from "../leauges-asset/Other-Clubs/Ajax/AjaxAwaySmall.jpg";
...
const AjaxAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>AJAX AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
