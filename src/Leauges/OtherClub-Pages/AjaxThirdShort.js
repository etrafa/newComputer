...
import ajaxFront from "../leauges-asset/Other-Clubs/Ajax/AjaxThirdShort.jpg";
import ajaxFrontSmall from "../leauges-asset/Other-Clubs/Ajax/AjaxThirdShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const AjaxThirdShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>AJAX THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
