...
import portoFront from "../leauges-asset/Other-Clubs/Porto/PortoHomeFront.png";
import portoBack from "../leauges-asset/Other-Clubs/Porto/PortoHomeBack.png";
import portoFrontSmall from "../leauges-asset/Other-Clubs/Porto/PortoHomeFrontSmall.png";
import portoBackSmall from "../leauges-asset/Other-Clubs/Porto/PortoHomeBackSmall.png";

import "../../Pages/ShirtSales.css";

const PortoHomeShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>FC PORTO HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
