...
import portoFront from "../leauges-asset/Other-Clubs/Benfica/BenficaThird.jpg";
import portoFrontSmall from "../leauges-asset/Other-Clubs/Benfica/BenficaThirdSmall.jpg";
import "../../Pages/ShirtSales.css";

const BenficaThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BENFICA THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default BenficaThirdShirt;
