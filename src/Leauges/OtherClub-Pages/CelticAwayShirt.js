...
import celticFront from "../leauges-asset/Other-Clubs/Celtic/CelticAway.jpg";
import celticFrontSmall from "../leauges-asset/Other-Clubs/Celtic/CelticAwaySmall.jpg";
import "../../Pages/ShirtSales.css";

const CelticAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>CELTIC AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default CelticAwayShirt;
