...
import portoFront from "../leauges-asset/Other-Clubs/Benfica/BenficaHome.jpg";
import portoFrontSmall from "../leauges-asset/Other-Clubs/Benfica/BenficaHomeSmall.jpg";
import "../../Pages/ShirtSales.css";

const BenficaHomeShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BENFICA HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default BenficaHomeShirt;
