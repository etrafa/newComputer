...
import ajaxFront from "../leauges-asset/Other-Clubs/Ajax/AjaxHomeFront.png";
import ajaxBack from "../leauges-asset/Other-Clubs/Ajax/AjaxHomeBack.png";
import ajaxFrontSmall from "../leauges-asset/Other-Clubs/Ajax/AjaxHomeFrontSmall.png";
import ajaxBackSmall from "../leauges-asset/Other-Clubs/Ajax/AjaxHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const AjaxHomeShirt = () => {
  const [image, setImage] = useState(ajaxFront);

  return (
    <div className="shirtSales__container">
      <img className="mainShirt__front" src={image} alt="" />
      <div className="mainShirt__small">
        <img src={ajaxFrontSmall} onClick={() => setImage(ajaxFront)} alt="" />
        <img src={ajaxBackSmall} onClick={() => setImage(ajaxBack)} alt="" />
      </div>
      <h1>AJAX HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
