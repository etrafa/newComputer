...
import ajaxFront from "../leauges-asset/Other-Clubs/Ajax/AjaxHomeShort.jpg";
import ajaxFrontSmall from "../leauges-asset/Other-Clubs/Ajax/AjaxHomeShortSmall.jpg";
...
const AjaxHomeShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>AJAX HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
