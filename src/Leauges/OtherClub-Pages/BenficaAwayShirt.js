...
import portoFront from "../leauges-asset/Other-Clubs/Benfica/BenficaAway.jpg";
import portoFrontSmall from "../leauges-asset/Other-Clubs/Benfica/BenficaAwaySmall.jpg";
import "../../Pages/ShirtSales.css";

const BenficaAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BENFICA AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default BenficaAwayShirt;
