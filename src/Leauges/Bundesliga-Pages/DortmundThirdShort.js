...
import dortmundFront from "../leauges-asset/Bundesliga/Dortmund/DortmundThirdShort.jpg";
import dortmundFrontSmall from "../leauges-asset/Bundesliga/Dortmund/DortmundThirdShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const DortmundThirdShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BORUSSIA DORTMUND THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default DortmundThirdShort;
