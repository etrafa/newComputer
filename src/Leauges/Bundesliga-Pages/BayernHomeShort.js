...
import bayernFront from "../leauges-asset/Bundesliga/Bayern/BayernHomeShort.jpg";
import bayernFrontSmall from "../leauges-asset/Bundesliga/Bayern/BayernHomeShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const BayernHomeShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BAYERN MUNICH HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default BayernHomeShort;
