...
import bayernFront from "../leauges-asset/Bundesliga/Bayern/BayernThirdFront.png";
import bayernBack from "../leauges-asset/Bundesliga/Bayern/BayernThirdBack.png";
import bayernFrontSmall from "../leauges-asset/Bundesliga/Bayern/BayernThirdFrontSmall.png";
import bayernBackSmall from "../leauges-asset/Bundesliga/Bayern/BayernThirdBackSmall.png";
import "../../Pages/ShirtSales.css";

const BayerThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BAYERN MUNICH THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default BayerThirdShirt;
