...
import bayernFront from "../leauges-asset/Bundesliga/Bayern/BayernAwayShort.jpg";
import bayernFrontSmall from "../leauges-asset/Bundesliga/Bayern/BayernAwayShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const BayernAwayShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BAYERN MUNICH AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default BayernAwayShort;
