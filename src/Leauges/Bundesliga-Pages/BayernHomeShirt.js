...
import bayernFront from "../leauges-asset/Bundesliga/Bayern/BayernHomeFront.png";
import bayernBack from "../leauges-asset/Bundesliga/Bayern/BayernHomeBack.png";
import bayernFrontSmall from "../leauges-asset/Bundesliga/Bayern/BayernHomeFrontSmall.png";
import bayernBackSmall from "../leauges-asset/Bundesliga/Bayern/BayernHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const BayernHomeShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BAYERN MUNICH HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default BayernHomeShirt;
