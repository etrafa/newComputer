...
import dortmundFront from "../leauges-asset/Bundesliga/Dortmund/DortmundAwayFront.jpg";
import dortmundBack from "../leauges-asset/Bundesliga/Dortmund/DortmundAwayBack.jpg";
import dortmundFrontSmall from "../leauges-asset/Bundesliga/Dortmund/DortmundAwayFrontSmall.jpg";
import dortmundBackSmall from "../leauges-asset/Bundesliga/Dortmund/DortmundAwayBackSmall.jpg";
import "../../Pages/ShirtSales.css";

const DortmundAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BORUSSIA DORTMUND AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default DortmundAwayShirt;
