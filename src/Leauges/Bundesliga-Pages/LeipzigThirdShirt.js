...
import leipzigFront from "../leauges-asset/Bundesliga/Leipzig/LeipzigThird.jpg";
import leipzigFrontSmall from "../leauges-asset/Bundesliga/Leipzig/LeipzigThirdSmall.jpg";
import "../../Pages/ShirtSales.css";

const LeipzigThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>RB LEIPZIG THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default LeipzigThirdShirt;
