...
import dortmundFront from "../leauges-asset/Bundesliga/Dortmund/DortmundHomeFront.jpg";
import dortmundBack from "../leauges-asset/Bundesliga/Dortmund/DortmundHomeBack.jpg";
import dortmundFrontSmall from "../leauges-asset/Bundesliga/Dortmund/DortmundHomeFrontSmall.jpg";
import dortmundBackSmall from "../leauges-asset/Bundesliga/Dortmund/DortmundHomeBackSmall.jpg";
import "../../Pages/ShirtSales.css";

const DortmundHomeShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BORUSSIA DORTMUND HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default DortmundHomeShirt;
