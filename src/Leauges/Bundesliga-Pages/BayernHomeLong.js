...
import bayernFront from "../leauges-asset/Bundesliga/Bayern/BayernHomeLong.jpg";
import bayernFrontSmall from "../leauges-asset/Bundesliga/Bayern/BayernHomeLongSmall.jpg";
import "../../Pages/ShirtSales.css";

const BayernHomeLongShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BAYERN MUNICH HOME LONG SLEEVE FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default BayernHomeLongShirt;
