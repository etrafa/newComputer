...
import leipzigFront from "../leauges-asset/Bundesliga/Leipzig/LeipzigHomeFront.png";
import leipzigBack from "../leauges-asset/Bundesliga/Leipzig/LeipzigHomeBack.png";
import leipzigFrontSmall from "../leauges-asset/Bundesliga/Leipzig/LeipzigHomeFrontSmall.png";
import leipzigBackSmall from "../leauges-asset/Bundesliga/Leipzig/LeipzigHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const LeipzigHomeShirt = () => {
  const [image, setImage] = useState(leipzigFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={leipzigFrontSmall}
          onClick={() => setImage(leipzigFront)}
          alt=""
        />
        <img
          src={leipzigBackSmall}
          onClick={() => setImage(leipzigBack)}
          alt=""
        />
      </div>
      <h1>RB LEIPZIG HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={leipzigFront} alt="" />
          <img src={leipzigBack} alt="" />
        </div>
      </div>
    </div>
  );
...
export default LeipzigHomeShirt;
