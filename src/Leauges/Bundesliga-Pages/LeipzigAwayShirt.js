...
import leipzigFront from "../leauges-asset/Bundesliga/Leipzig/LeipzigAway.jpg";
import leipzigFrontSmall from "../leauges-asset/Bundesliga/Leipzig/LeipzigAwaySmall.jpg";
import "../../Pages/ShirtSales.css";

const LeipzigAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>RB LEIPZIG AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default LeipzigAwayShirt;
