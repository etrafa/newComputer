...
import dortmundFront from "../leauges-asset/Bundesliga/Dortmund/DortmundThirdFront.jpg";
import dortmundBack from "../leauges-asset/Bundesliga/Dortmund/DortmundThirdBack.jpg";
import dortmundFrontSmall from "../leauges-asset/Bundesliga/Dortmund/DortmundThirdFrontSmall.jpg";
import dortmundBackSmall from "../leauges-asset/Bundesliga/Dortmund/DortmundThirdBackSmall.jpg";
import "../../Pages/ShirtSales.css";

const DortmundThirdShirt = () => {
  const [image, setImage] = useState(dortmundFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        ...
        />
        <img
          src={dortmundBackSmall}
          onClick={() => setImage(dortmundBack)}
          alt=""
        />
      </div>
      <h1>BORUSSIA DORTMUND THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={dortmundFront} alt="" />
          <img src={dortmundBack} alt="" />
        </div>
      </div>
    </div>
  );
...
export default DortmundThirdShirt;
