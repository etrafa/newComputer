...
import bayernFront from "../leauges-asset/Bundesliga/Bayern/BayernThirdShort.jpg";
import bayernFrontSmall from "../leauges-asset/Bundesliga/Bayern/BayernThirdShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const BayernThirdShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BAYERN MUNICH THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default BayernThirdShort;
