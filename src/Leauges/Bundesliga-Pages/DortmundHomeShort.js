...
import dortmundFront from "../leauges-asset/Bundesliga/Dortmund/DortmundHomeShort.jpg";
import dortmundFrontSmall from "../leauges-asset/Bundesliga/Dortmund/DortmundHomeShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const DortmundHomeShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BORUSSIA DORTMUND HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default DortmundHomeShort;
