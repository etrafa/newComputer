...
import psgFront from "../leauges-asset/LigueOne/PSG/PsgHomeWomen.jpg";
import psgFrontSmall from "../leauges-asset/LigueOne/PSG/PsgHomeWomenSmall.jpg";
...
const PsgHomeWomen = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>PARIS SAINT-GERMAIN HOME WOMEN'S FOOTBALL SHIRTS 21/22</h1>
      <hr />
