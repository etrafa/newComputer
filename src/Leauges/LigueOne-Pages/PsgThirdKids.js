...
import psgFront from "../leauges-asset/LigueOne/PSG/PsgThirdKids.jpg";
import psgFrontSmall from "../leauges-asset/LigueOne/PSG/PsgThirdKidsSmall.jpg";
...
const PsgThirdKids = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>PARIS SAINT-GERMAIN THIRD KIDS FOOTBALL KIT 21/22</h1>
      <hr />
