...
import psgFront from "../leauges-asset/LigueOne/PSG/PsgHomeKids.jpg";
import psgFrontSmall from "../leauges-asset/LigueOne/PSG/PsgHomeKidsSmall.jpg";
...
const PsgHomeKids = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>PARIS SAINT-GERMAIN HOME KIDS FOOTBALL KIT 21/22</h1>
      <hr />
