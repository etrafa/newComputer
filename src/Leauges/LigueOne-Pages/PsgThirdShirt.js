...
import psgFront from "../leauges-asset/LigueOne/PSG/PsgThirdFront.png";
import psgBack from "../leauges-asset/LigueOne/PSG/PsgThirdBack.png";
import psgFrontSmall from "../leauges-asset/LigueOne/PSG/PsgThirdFrontSmall.png";
import psgBackSmall from "../leauges-asset/LigueOne/PSG/PsgThirdBackSmall.png";
import "../../Pages/ShirtSales.css";

const PsgThirdShirt = () => {
  const [image, setImage] = useState(psgFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>PARIS SAINT-GERMAIN THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
