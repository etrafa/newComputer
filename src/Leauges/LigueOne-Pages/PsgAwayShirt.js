...
import psgFront from "../leauges-asset/LigueOne/PSG/PsgAwayFront.png";
import psgBack from "../leauges-asset/LigueOne/PSG/PsgAwayBack.png";
import psgFrontSmall from "../leauges-asset/LigueOne/PSG/PsgAwayFrontSmall.png";
import psgBackSmall from "../leauges-asset/LigueOne/PSG/PsgAwayBackSmall.png";
...
const PsgAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>PARIS SAINT-GERMAIN AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
