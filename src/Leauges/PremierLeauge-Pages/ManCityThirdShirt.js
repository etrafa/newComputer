...
import manCityFront from "../leauges-asset/Premier-Leauge/ManCity/ManCityThirdFront.jpg";
import manCityBack from "../leauges-asset/Premier-Leauge/ManCity/ManCityThirdBack.jpg";
import manCityFrontSmall from "../leauges-asset/Premier-Leauge/ManCity/ManCityThirdFrontSmall.jpg";
import manCityBackSmall from "../leauges-asset/Premier-Leauge/ManCity/ManCityThirdBackSmall.jpg";
import "../../Pages/ShirtSales.css";

const ManCityThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHESTER CITY THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={manCityFront} alt="" />
          <img src={manCityBack} alt="" />
        </div>
      </div>
    </div>
  );
...
export default ManCityThirdShirt;
