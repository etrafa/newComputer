...
import westhamFront from "../leauges-asset/Premier-Leauge/Westham/WesthamHome.jpg";
import westhamFrontSmall from "../leauges-asset/Premier-Leauge/Westham/WesthamHomeSmall.jpg";
import "../../Pages/ShirtSales.css";

const WesthamHomeShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>WESTHAM UNITED HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default WesthamHomeShirt;
