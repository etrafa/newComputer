...
import chelseaFront from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaHomeKid.jpg";
import chelseaFrontSmall from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaHomeKidSmall.jpg";
import "../../Pages/ShirtSales.css";

const ChelseaHomeKids = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>CHELSEA HOME KIDS FOOTBALL KIT 21/22</h1>
      <hr />
...
export default ChelseaHomeKids;
