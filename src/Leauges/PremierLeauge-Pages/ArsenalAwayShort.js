...
import arsenalFront from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalAwayShort.jpg";
import arsenalFrontSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalAwayShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const ArsenalAwayShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>Arsenal Away Football Shorts 21/22</h1>
      <hr />
...
export default ArsenalAwayShort;
