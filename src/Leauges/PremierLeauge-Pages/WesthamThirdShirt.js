...
import westhamFront from "../leauges-asset/Premier-Leauge/Westham/WesthamThird.jpg";
import westhamFrontSmall from "../leauges-asset/Premier-Leauge/Westham/WesthamThirdSmall.jpg";
import "../../Pages/ShirtSales.css";

const WesthamThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>WESTHAM UNITED THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default WesthamThirdShirt;
