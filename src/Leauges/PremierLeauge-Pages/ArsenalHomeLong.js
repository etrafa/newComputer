...
import arsenalFront from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalHomeLong.png";
import arsenalFrontSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalHomeLongSmall.png";
import "../../Pages/ShirtSales.css";

const ArsenalHomeLong = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ARSENAL HOME LONG SLEEVE FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default ArsenalHomeLong;
