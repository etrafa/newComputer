...
import chelseaFront from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaAwayKid.jpg";
import chelseaFrontSmall from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaAwayKidSmall.jpg";
import "../../Pages/ShirtSales.css";

const ChelseaAwayKids = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>CHELSEA AWAY KIDS FOOTBALL KIT 21/22</h1>
      <hr />
...
export default ChelseaAwayKids;
