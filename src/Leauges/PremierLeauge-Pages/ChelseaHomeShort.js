...
import chelseaFront from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaHomeShort.jpg";
import chelseaFrontSmall from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaHomeShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const ChelseaHomeShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>CHELSEA HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ChelseaHomeShort;
