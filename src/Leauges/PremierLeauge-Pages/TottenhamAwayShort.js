...
import tottenhamFront from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamAwayShort.jpg";
import tottenhamFrontSmall from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamAwayShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const TottenhamAwayShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>TOTTENHAM HOTSPUR AWAY FOOTBALL SHORT 21/22</h1>
      <hr />
...
export default TottenhamAwayShort;
