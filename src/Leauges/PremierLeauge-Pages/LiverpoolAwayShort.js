...
import liverpoolFront from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolAwayShorts.jpg";
import liverpoolFrontSmall from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolAwayShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const LiverpoolAwayShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>LIVERPOOL AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default LiverpoolAwayShorts;
