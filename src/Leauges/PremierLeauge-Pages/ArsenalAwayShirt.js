...
import arsenalFront from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalAwayFront.png";
import arsenalBack from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalAwayBack.png";
import arsenalFrontSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalAwayFrontSmall.png";
import arsenalBackSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const ArsenalAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ARSENAL AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default ArsenalAwayShirt;
