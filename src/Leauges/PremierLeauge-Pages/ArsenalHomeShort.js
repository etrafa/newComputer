...
import arsenalFront from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalHomeShort.jpg";
import arsenalFrontSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalHomeShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const ArsenalHomeShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ARSENAL HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ArsenalHomeShort;
