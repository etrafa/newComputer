...
import liverpoolFront from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolThirdKids.jpg";
import liverpoolFrontSmall from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolThirdKidsSmall.jpg";
import "../../Pages/ShirtSales.css";

const LiverpoolThirdKids = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>LIVERPOOL THIRD KIDS FOOTBALL KIT 21/22</h1>
      <hr />
...
export default LiverpoolThirdKids;
