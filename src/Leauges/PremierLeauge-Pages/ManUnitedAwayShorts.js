...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedAwayShort.jpg";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedAwayShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const ManUnitedAwayShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHSTER AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ManUnitedAwayShorts;
