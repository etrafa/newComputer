...
import chelseaFront from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaAwayFront.png";
import chelseaBack from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaAwayBack.png";
import chelseaFrontSmall from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaAwayFrontSmall.png";
import chelseaBackSmall from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const ChelseaAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>CHELSEA AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default ChelseaAwayShirt;
