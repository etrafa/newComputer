...
import chelseaFront from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaThirdShort.jpg";
import chelseaFrontSmall from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaThirdShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const ChelseaThirdShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>CHELSEA THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ChelseaThirdShort;
