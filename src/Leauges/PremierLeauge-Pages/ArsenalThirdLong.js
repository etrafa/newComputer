...
import arsenalFront from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalThirdLong.jpg";
import arsenalFrontSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalThirdLongSmall.jpg";
import "../../Pages/ShirtSales.css";

const ArsenalThirdLong = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ARSENAL THIRD LONG SLEEVE FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default ArsenalThirdLong;
