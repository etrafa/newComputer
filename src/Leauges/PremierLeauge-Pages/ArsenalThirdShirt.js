...
import arsenalFront from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalThirdFront.png";
import arsenalBack from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalThirdBack.png";
import arsenalFrontSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalThirdFrontSmall.png";
import arsenalBackSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalThirdBackSmall.png";
import "../../Pages/ShirtSales.css";

const ArsenalThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ARSENAL THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={arsenalFront} alt="" />
          <img src={arsenalBack} alt="" />
        </div>
      </div>
    </div>
  );
...
export default ArsenalThirdShirt;
