...
import tottenhamFront from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamThirdFront.png";
import tottenhamBack from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamThirdBack.png";
import tottenhamFrontSmall from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamThirdFrontSmall.png";
import tottenhamBackSmall from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamThirdBackSmall.png";
import "../../Pages/ShirtSales.css";

const TottenhamThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>TOTTENHAM HOTSPUR HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default TottenhamThirdShirt;
