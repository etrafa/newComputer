...
import westHamFront from "../leauges-asset/Premier-Leauge/Westham/WesthamAwayShort.jpg";
import westHamFrontSmall from "../leauges-asset/Premier-Leauge/Westham/WesthamAwayShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const WesthamAwayShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>WEST HAM UNITED AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default WesthamAwayShorts;
