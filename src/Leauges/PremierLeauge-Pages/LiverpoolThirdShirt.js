...
import liverpoolFront from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolThirdFront.png";
import liverpoolBack from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolThirdBack.png";
import liverpoolFrontSmall from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolThirdFrontSmall.png";
import liverpoolBackSmall from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolThirdBackSmall.png";
import "../../Pages/ShirtSales.css";

const LiverpoolThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>LIVERPOOL THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={liverpoolFront} alt="" />
          <img src={liverpoolBack} alt="" />
        </div>
      </div>
    </div>
  );
...
export default LiverpoolThirdShirt;
