...
import chelseaFront from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaAwayShort.jpg";
import chelseaFrontSmall from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaAwayShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const ChelseaAwayShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>CHELSEA AWAY FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ChelseaAwayShort;
