...
import liverpoolFront from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolHomeFront.jpg";
import liverpoolBack from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolHomeBack.jpg";
import liverpoolFrontSmall from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolHomeFrontSmall.jpg";
import liverpoolBackSmall from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolHomeBackSmall.jpg";
import "../../Pages/ShirtSales.css";

const LiverpoolHomeShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>LIVERPOOL HOME FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default LiverpoolHomeShirt;
