...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedHomeShort.jpg";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedHomeShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const ManUnitedHomeShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHSTER HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ManUnitedHomeShorts;
