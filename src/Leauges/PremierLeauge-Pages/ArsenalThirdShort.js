...
import arsenalFront from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalThirdShort.jpg";
import arsenalFrontSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalThirdShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const ArsenalThirdShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ARSENAL THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ArsenalThirdShort;
