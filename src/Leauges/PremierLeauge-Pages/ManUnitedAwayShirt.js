...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedAwayFront.png";
import manUnitedBack from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedAwayBack.png";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedAwayFrontSmall.png";
import manUnitedBackSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const ManUnitedAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHESTER UNITED AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default ManUnitedAwayShirt;
