...
import chelseaFront from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaThirdFront.jpg";
import chelseaBack from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaThirdBack.jpg";
import chelseaFrontSmall from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaThirdFrontSmall.jpg";
import chelseaBackSmall from "../leauges-asset/Premier-Leauge/Chelsea/ChelseaThirdBackSmall.jpg";
import "../../Pages/ShirtSales.css";

const ChelseaThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>CHELSEA THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default ChelseaThirdShirt;
