...
import westHamFront from "../leauges-asset/Premier-Leauge/Westham/WesthamHomeShorts.jpg";
import westHamFrontSmall from "../leauges-asset/Premier-Leauge/Westham/WesthamHomeShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const WesthamHomeShorts = () => {
  const [image, setImage] = useState(westHamFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={westHamFrontSmall}
          onClick={() => setImage(westHamFront)}
          alt=""
        />
      </div>
      <h1>WEST HAM UNITED HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default WesthamHomeShorts;
