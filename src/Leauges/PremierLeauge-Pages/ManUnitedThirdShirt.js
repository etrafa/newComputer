...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedThirdFront.png";
import manUnitedBack from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedThirdBack.png";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedThirdFrontSmall.png";
import manUnitedBackSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedThirdBackSmall.png";
import "../../Pages/ShirtSales.css";

const ManUnitedThirdShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHESTER UNITED THIRD FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default ManUnitedThirdShirt;
