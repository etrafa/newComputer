...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedHomeLongFront.png";
import manUnitedBack from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedHomeLongBack.png";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedHomeLongFrontSmall.png";
import manUnitedBackSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedHomeLongBackSmall.png";
import "../../Pages/ShirtSales.css";

const ManUnitedHomeLong = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHESTER UNITED HOME LONG SLEEVE FOOTBALL SHIRT 21/22</h1>
      <hr />
      <div className="shirtSales__price__container">
        <p className="shirtSales__price">$55.00</p>
...
export default ManUnitedHomeLong;
