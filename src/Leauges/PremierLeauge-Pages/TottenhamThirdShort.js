...
import tottenhamFront from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamThirdShort.jpg";
import tottenhamFrontSmall from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamThirdShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const TottenhamThirdShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>TOTTENHAM HOTSPUR THIRD FOOTBALL SHORT 21/22</h1>
      <hr />
...
export default TottenhamThirdShort;
