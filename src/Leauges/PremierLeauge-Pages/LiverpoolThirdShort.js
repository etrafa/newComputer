...
import liverpoolFront from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolThirdShorts.jpg";
import liverpoolFrontSmall from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolThirdShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const LiverpoolThirdShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>LIVERPOOL THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default LiverpoolThirdShorts;
