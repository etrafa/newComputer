...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManCity/ManCityHomeShorts.jpg";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManCity/ManCityHomeShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const ManCityHomeShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHSTER HOME THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ManCityHomeShorts;
