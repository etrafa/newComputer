...
import arsenalFront from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalHomeFrontWomen.png";
import arsenalFrontSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalHomeFrontWomenSmall.png";
import "../../Pages/ShirtSales.css";

const ArsenalHomeWomen = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>Arsenal Home Women's Football Shirt 21/22</h1>
      <hr />
...
export default ArsenalHomeWomen;
