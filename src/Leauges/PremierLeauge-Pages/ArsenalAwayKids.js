...
import arsenalFront from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalAwayKid.jpg";
import arsenalFrontSmall from "../leauges-asset/Premier-Leauge/Arsenal/ArsenalAwayKidSmall.jpg";
import "../../Pages/ShirtSales.css";

const ArsenalAwayKids = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ARSENAL AWAY KIDS FOOTBALL KIT 21/22</h1>
      <hr />
...
export default ArsenalAwayKids;
