...
import tottenhamFront from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamHomeShort.jpg";
import tottenhamFrontSmall from "../leauges-asset/Premier-Leauge/Tottenham/TottenhamHomeShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const TottenhamHomeShort = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>TOTTENHAM HOTSPUR HOME FOOTBALL SHORT 21/22</h1>
      <hr />
...
export default TottenhamHomeShort;
