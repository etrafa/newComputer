...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedThirdLong.jpg";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedThirdLongSmall.jpg";
import "../../Pages/ShirtSales.css";

const ManUnitedThirdLong = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHESTER UNITED THIRD LONG SLEEVE FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default ManUnitedThirdLong;
