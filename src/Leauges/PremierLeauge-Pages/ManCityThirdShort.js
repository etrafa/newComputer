...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManCity/ManCityThirdShorts.jpg";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManCity/ManCityThirdShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const ManCityThirdShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHSTER CITY THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ManCityThirdShorts;
