...
import manCityFront from "../leauges-asset/Premier-Leauge/ManCity/ManCityAwayFront.jpg";
import manCityBack from "../leauges-asset/Premier-Leauge/ManCity/ManCityAwayBack.jpg";
import manCityFrontSmall from "../leauges-asset/Premier-Leauge/ManCity/ManCityAwayFrontSmall.jpg";
import manCityBackSmall from "../leauges-asset/Premier-Leauge/ManCity/ManCityAwayBackSmall.jpg";
import "../../Pages/ShirtSales.css";

const ManCityAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHESTER CITY AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default ManCityAwayShirt;
