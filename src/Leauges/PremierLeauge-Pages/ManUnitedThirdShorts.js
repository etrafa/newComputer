...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedThirdShort.jpg";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManUnited/ManUnitedThirdShortSmall.jpg";
import "../../Pages/ShirtSales.css";

const ManUnitedThirdShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHSTER THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ManUnitedThirdShorts;
