...
import liverpoolFront from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolHomeShorts.jpg";
import liverpoolFrontSmall from "../leauges-asset/Premier-Leauge/Liverpool/LiverpoolHomeShortsSmall.jpg";
import "../../Pages/ShirtSales.css";

const LiverpoolHomeShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>LIVERPOOL HOME FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default LiverpoolHomeShorts;
