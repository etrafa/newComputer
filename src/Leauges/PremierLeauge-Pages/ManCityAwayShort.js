...
import manUnitedFront from "../leauges-asset/Premier-Leauge/ManCity/ManCityAwayShorts.png";
import manUnitedFrontSmall from "../leauges-asset/Premier-Leauge/ManCity/ManCityAwayShortsSmall.png";
import "../../Pages/ShirtSales.css";

const ManCityAwayShorts = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>MANCHSTER AWAY THIRD FOOTBALL SHORTS 21/22</h1>
      <hr />
...
export default ManCityAwayShorts;
