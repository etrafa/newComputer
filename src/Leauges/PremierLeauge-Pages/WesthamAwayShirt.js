...
import westhamFront from "../leauges-asset/Premier-Leauge/Westham/WesthamAway.jpg";
import westhamFrontSmall from "../leauges-asset/Premier-Leauge/Westham/WesthamAwaySmall.jpg";
import "../../Pages/ShirtSales.css";

const WesthamAwayShirt = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>WESTHAM UNITED AWAY FOOTBALL SHIRT 21/22</h1>
      <hr />
...
export default WesthamAwayShirt;
