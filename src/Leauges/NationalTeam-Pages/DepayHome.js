...
import depayFront from "../leauges-asset/National-Teams/Netherland-Depay/depayHomeFront.png";
import depayBack from "../leauges-asset/National-Teams/Netherland-Depay/depayHomeBack.png";
import depayFrontSmall from "../leauges-asset/National-Teams/Netherland-Depay/depayHomeFrontSmall.png";
import depayBackSmall from "../leauges-asset/National-Teams/Netherland-Depay/depayHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const DepayHome = () => {
  const [image, setImage] = useState(depayFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={depayFrontSmall}
          onClick={() => setImage(depayFront)}
          alt=""
        />
        <img src={depayBackSmall} onClick={() => setImage(depayBack)} alt="" />
      </div>
      <h1>NETHERLANDS HOME MEMPHIS DEPAY FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={depayFront} alt="" />
          <img src={depayBack} alt="" />
        </div>
      </div>
    </div>
  );
