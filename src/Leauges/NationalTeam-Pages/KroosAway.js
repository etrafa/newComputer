...
import kroosFront from "../leauges-asset/National-Teams/Germany-Kroos/kroosAwayFront.png";
import kroosBack from "../leauges-asset/National-Teams/Germany-Kroos/kroosAwayBack.png";
import kroosFrontSmall from "../leauges-asset/National-Teams/Germany-Kroos/kroosAwayFrontSmall.png";
import kroosBackSmall from "../leauges-asset/National-Teams/Germany-Kroos/kroosAwayBackSmall.png";
...
const KroosAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>GERMANY AWAY TONI KROOS FOOTBALL SHIRT 20/21</h1>
      <hr />
