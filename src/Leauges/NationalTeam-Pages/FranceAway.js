...
import franceFront from "../leauges-asset/National-Teams/France/FranceAwayFront.png";
import franceBack from "../leauges-asset/National-Teams/France/FranceAwayBack.png";
import franceFrontSmall from "../leauges-asset/National-Teams/France/FranceAwayFrontSmall.png";
import franceBackSmall from "../leauges-asset/National-Teams/France/FranceAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const FranceAway = () => {
  const [image, setImage] = useState(franceFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={franceFrontSmall}
          onClick={() => setImage(franceFront)}
          alt=""
        />
        <img
          src={franceBackSmall}
          onClick={() => setImage(franceBack)}
          alt=""
        />
      </div>
      <h1>FRANCE AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={franceFront} alt="" />
          <img src={franceBack} alt="" />
        </div>
      </div>
    </div>
  );
