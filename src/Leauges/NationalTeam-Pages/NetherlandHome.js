...
import netherlandFront from "../leauges-asset/National-Teams/Netherland/NetherlandHomeFront.png";
import netherlandBack from "../leauges-asset/National-Teams/Netherland/NetherlandHomeBack.png";
import netherlandFrontSmall from "../leauges-asset/National-Teams/Netherland/NetherlandHomeFrontSmall.png";
import netherlandBackSmall from "../leauges-asset/National-Teams/Netherland/NetherlandHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const NetherlandHome = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>NETHERLAND HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
