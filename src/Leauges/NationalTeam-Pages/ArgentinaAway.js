...
import argentinaFront from "../leauges-asset/National-Teams/Argentina/ArgentinaAwayFront.png";
import argentinaBack from "../leauges-asset/National-Teams/Argentina/ArgentinaAwayBack.png";
import argentinaFrontSmall from "../leauges-asset/National-Teams/Argentina/ArgentinaAwayFrontSmall.png";
import argentinaBackSmall from "../leauges-asset/National-Teams/Argentina/ArgentinaAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const ArgentinaAway = () => {
  const [image, setImage] = useState(argentinaFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={argentinaFrontSmall}
          onClick={() => setImage(argentinaFront)}
          alt=""
        />
        <img
          src={argentinaBackSmall}
          onClick={() => setImage(argentinaBack)}
          alt=""
        />
      </div>
      <h1>ARGENTINA AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={argentinaFront} alt="" />
          <img src={argentinaBack} alt="" />
        </div>
      </div>
    </div>
  );
