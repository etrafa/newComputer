...
import depayFront from "../leauges-asset/National-Teams/Netherland-Depay/depayAwayFront.png";
import depayBack from "../leauges-asset/National-Teams/Netherland-Depay/depayAwayBack.png";
import depayFrontSmall from "../leauges-asset/National-Teams/Netherland-Depay/depayAwayFrontSmall.png";
import depayBackSmall from "../leauges-asset/National-Teams/Netherland-Depay/depayAwayBackSmall.png";
...
const DepayAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>NETHERLANDS AWAY MEMPHIS DEPAY FOOTBALL SHIRT 20/21</h1>
      <hr />
