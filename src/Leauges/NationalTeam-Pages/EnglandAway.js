...
import englandFront from "../leauges-asset/National-Teams/England/EnglandAwayFront.png";
import englandBack from "../leauges-asset/National-Teams/England/EnglandAwayBack.png";
import englandFrontSmall from "../leauges-asset/National-Teams/England/EnglandAwayFrontSmall.png";
import englandBackSmall from "../leauges-asset/National-Teams/England/EnglandAwayBackSmall.png";
...
const EnglandAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ENGLAND AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
