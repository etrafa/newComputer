...
import belgiumFront from "../leauges-asset/National-Teams/Belgium/BelgiumHomeFront.png";
import belgiumBack from "../leauges-asset/National-Teams/Belgium/BelgiumHomeBack.png";
import belgiumFrontSmall from "../leauges-asset/National-Teams/Belgium/BelgiumHomeFrontSmall.png";
import belgiumBackSmall from "../leauges-asset/National-Teams/Belgium/BelgiumHomeBackSmall.png";
...
const BelgiumHome = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BELGIUM HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
