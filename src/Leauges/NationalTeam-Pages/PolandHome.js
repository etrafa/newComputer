...
import polandFront from "../leauges-asset/National-Teams/Poland/PolandHomeFront.png";
import polandBack from "../leauges-asset/National-Teams/Poland/PolandHomeBack.png";
import polandFrontSmall from "../leauges-asset/National-Teams/Poland/PolandHomeFrontSmall.png";
import polandBackSmall from "../leauges-asset/National-Teams/Poland/PolandHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const PolandHome = () => {
  const [image, setImage] = useState(polandFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={polandFrontSmall}
          onClick={() => setImage(polandFront)}
          alt=""
        />
        <img
          src={polandBackSmall}
          onClick={() => setImage(polandBack)}
          alt=""
        />
      </div>
      <h1>POLAND HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={polandFront} alt="" />
          <img src={polandBack} alt="" />
        </div>
      </div>
    </div>
  );
