...
import franceFront from "../leauges-asset/National-Teams/France/FranceHomeFront.png";
import franceBack from "../leauges-asset/National-Teams/France/FranceHomeBack.png";
import franceFrontSmall from "../leauges-asset/National-Teams/France/FranceHomeFrontSmall.png";
import franceBackSmall from "../leauges-asset/National-Teams/France/FranceHomeBackSmall.png";
...
const FranceHome = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>FRANCE HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
