...
import spainFront from "../leauges-asset/National-Teams/Spain/SpainHomeFront.png";
import spainBack from "../leauges-asset/National-Teams/Spain/SpainHomeBack.png";
import spainFrontSmall from "../leauges-asset/National-Teams/Spain/SpainHomeFrontSmall.png";
import spainBackSmall from "../leauges-asset/National-Teams/Spain/SpainHomeBackSmall.png";
...
const SpainHome = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>SPAIN HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
