...
import croatiaFront from "../leauges-asset/National-Teams/Croatia/CroatiaAwayFront.png";
import croatiaBack from "../leauges-asset/National-Teams/Croatia/CroatiaAwayBack.png";
import croatiaFrontSmall from "../leauges-asset/National-Teams/Croatia/CroatiaAwayFrontSmall.png";
import croatiaBackSmall from "../leauges-asset/National-Teams/Croatia/CroatiaAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const CroatiaAway = () => {
  const [image, setImage] = useState(croatiaFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={croatiaFrontSmall}
          onClick={() => setImage(croatiaFront)}
          alt=""
        />
        <img
          src={croatiaBackSmall}
          onClick={() => setImage(croatiaBack)}
          alt=""
        />
      </div>
      <h1>CROATIA AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={croatiaFront} alt="" />
          <img src={croatiaBack} alt="" />
        </div>
      </div>
    </div>
  );
