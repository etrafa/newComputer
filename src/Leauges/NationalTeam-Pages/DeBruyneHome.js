...
import deBruyneFront from "../leauges-asset/National-Teams/Belgium-DeBruyne/deBruyneHomeFront.png";
import deBruyneBack from "../leauges-asset/National-Teams/Belgium-DeBruyne/deBruyneHomeBack.png";
import deBruyneFrontSmall from "../leauges-asset/National-Teams/Belgium-DeBruyne/deBruyneHomeFrontSmall.png";
import deBruyneBackSmall from "../leauges-asset/National-Teams/Belgium-DeBruyne/deBruyneHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const DeBruyneHome = () => {
  const [image, setImage] = useState(deBruyneFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={deBruyneFrontSmall}
          onClick={() => setImage(deBruyneFront)}
          alt=""
        />
        <img
          src={deBruyneBackSmall}
          onClick={() => setImage(deBruyneBack)}
          alt=""
        />
      </div>
      <h1>BELGIUM HOME KEVIN DE BRUYNE FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={deBruyneFront} alt="" />
          <img src={deBruyneBack} alt="" />
        </div>
      </div>
    </div>
  );
