...
import mbappeFront from "../leauges-asset/National-Teams/France-Mbappe/mbappeAwayFront.png";
import mbappeBack from "../leauges-asset/National-Teams/France-Mbappe/mbappeAwayBack.png";
import mbappeFrontSmall from "../leauges-asset/National-Teams/France-Mbappe/mbappeAwayFrontSmall.png";
import mbappeBackSmall from "../leauges-asset/National-Teams/France-Mbappe/mbappeAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const MbappeAway = () => {
  const [image, setImage] = useState(mbappeFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={mbappeFrontSmall}
          onClick={() => setImage(mbappeFront)}
          alt=""
        />
        <img
          src={mbappeBackSmall}
          onClick={() => setImage(mbappeBack)}
          alt=""
        />
      </div>
      <h1>FRANCE AWAY KYLIAN MBAPPÉ FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={mbappeFront} alt="" />
          <img src={mbappeBack} alt="" />
        </div>
      </div>
    </div>
  );
