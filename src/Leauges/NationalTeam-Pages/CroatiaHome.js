...
import croatiaFront from "../leauges-asset/National-Teams/Croatia/CroatiaHomeFront.png";
import croatiaBack from "../leauges-asset/National-Teams/Croatia/CroatiaHomeBack.png";
import croatiaFrontSmall from "../leauges-asset/National-Teams/Croatia/CrotiaHomeFrontSmall.png";
import croatiaBackSmall from "../leauges-asset/National-Teams/Croatia/CroatiaHomeBackSmall.png";
...
const CroatiaHome = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>CROATIA HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
