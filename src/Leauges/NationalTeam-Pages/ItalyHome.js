...
import italyFront from "../leauges-asset/National-Teams/Italy/ItalyHomeFront.png";
import italyBack from "../leauges-asset/National-Teams/Italy/ItalyHomeBack.png";
import italyFrontSmall from "../leauges-asset/National-Teams/Italy/ItalyHomeFrontSmall.png";
import italyBackSmall from "../leauges-asset/National-Teams/Italy/ItalyHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const ItalyHome = () => {
  const [image, setImage] = useState(italyFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={italyFrontSmall}
          onClick={() => setImage(italyFront)}
          alt=""
        />
        <img src={italyBackSmall} onClick={() => setImage(italyBack)} alt="" />
      </div>
      <h1>ITALY HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={italyFront} alt="" />
          <img src={italyBack} alt="" />
        </div>
      </div>
    </div>
  );
