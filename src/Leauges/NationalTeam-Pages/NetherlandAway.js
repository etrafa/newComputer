...
import netherlandFront from "../leauges-asset/National-Teams/Netherland/NetherlandAwayFront.png";
import netherlandBack from "../leauges-asset/National-Teams/Netherland/NetherlandAwayBack.png";
import netherlandFrontSmall from "../leauges-asset/National-Teams/Netherland/NetherlandAwayFrontSmall.png";
import netherlandBackSmall from "../leauges-asset/National-Teams/Netherland/NetherlandAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const NetherlandAway = () => {
  const [image, setImage] = useState(netherlandFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={netherlandFrontSmall}
          onClick={() => setImage(netherlandFront)}
          alt=""
        />
        <img
          src={netherlandBackSmall}
          onClick={() => setImage(netherlandBack)}
          alt=""
        />
      </div>
      <h1>NETHERLAND AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={netherlandFront} alt="" />
          <img src={netherlandBack} alt="" />
        </div>
      </div>
    </div>
  );
