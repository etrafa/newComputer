...
import deJongFront from "../leauges-asset/National-Teams/Netherland-DeJong/deJongAwayFront.png";
import deJongBack from "../leauges-asset/National-Teams/Netherland-DeJong/deJongAwayBack.png";
import deJongFrontSmall from "../leauges-asset/National-Teams/Netherland-DeJong/deJongAwayFrontSmall.png";
import deJongBackSmall from "../leauges-asset/National-Teams/Netherland-DeJong/deJongAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const DeJongAway = () => {
  const [image, setImage] = useState(deJongFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={deJongFrontSmall}
          onClick={() => setImage(deJongFront)}
          alt=""
        />
        <img
          src={deJongBackSmall}
          onClick={() => setImage(deJongBack)}
          alt=""
        />
      </div>
      <h1>NETHERLANDS AWAY FRENKIE DE JONG FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={deJongFront} alt="" />
          <img src={deJongBack} alt="" />
        </div>
      </div>
    </div>
  );
