...
import spainFront from "../leauges-asset/National-Teams/Spain/SpainAwayFront.png";
import spainBack from "../leauges-asset/National-Teams/Spain/SpainAwayBack.png";
import spainFrontSmall from "../leauges-asset/National-Teams/Spain/SpainAwayFrontSmall.png";
import spainBackSmall from "../leauges-asset/National-Teams/Spain/SpainAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const SpainAway = () => {
  const [image, setImage] = useState(spainFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={spainFrontSmall}
          onClick={() => setImage(spainFront)}
          alt=""
        />
        <img src={spainBackSmall} onClick={() => setImage(spainBack)} alt="" />
      </div>
      <h1>SPAIN AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={spainFront} alt="" />
          <img src={spainBack} alt="" />
        </div>
      </div>
    </div>
  );
