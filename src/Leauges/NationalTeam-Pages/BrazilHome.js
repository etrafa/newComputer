...
import brazilHomeFront from "../leauges-asset/National-Teams/Brazil/BrazilHome.jpg";
import brazilHomeFrontSmall from "../leauges-asset/National-Teams/Brazil/BrazilHomeSmall.jpg";
import "../../Pages/ShirtSales.css";

const BrazilHome = () => {
  const [image, setImage] = useState(brazilHomeFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={brazilHomeFrontSmall}
          onClick={() => setImage(brazilHomeFront)}
          alt=""
        />
      </div>
      <h1>BRAZIL HOME FOOTBALL SHIRT 2021</h1>
      <hr />
