...
import griezmannFront from "../leauges-asset/National-Teams/France-Griezmann/griezmannHomeFront.png";
import griezmannBack from "../leauges-asset/National-Teams/France-Griezmann/griezmannHomeBack.png";
import griezmannFrontSmall from "../leauges-asset/National-Teams/France-Griezmann/griezmannHomeFrontSmall.png";
import griezmannBackSmall from "../leauges-asset/National-Teams/France-Griezmann/griezmannHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const GriezmannHome = () => {
  const [image, setImage] = useState(griezmannFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={griezmannFrontSmall}
          onClick={() => setImage(griezmannFront)}
          alt=""
        />
        <img
          src={griezmannBackSmall}
          onClick={() => setImage(griezmannBack)}
          alt=""
        />
      </div>
      <h1>FRANCE HOME ANTOINE GRIEZMANN FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={griezmannFront} alt="" />
          <img src={griezmannBack} alt="" />
        </div>
      </div>
    </div>
  );
