...
import italyFront from "../leauges-asset/National-Teams/Italy/ItalyAwayFront.png";
import italyFrontSmall from "../leauges-asset/National-Teams/Italy/ItalyAwayFrontSmall.png";
...
const ItalyAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ITALY AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
