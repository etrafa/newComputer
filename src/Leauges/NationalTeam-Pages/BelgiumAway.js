...
import belgiumFront from "../leauges-asset/National-Teams/Belgium/BelgiumAwayFront.png";
import belgiumBack from "../leauges-asset/National-Teams/Belgium/BelgiumAwayBack.png";
import belgiumFrontSmall from "../leauges-asset/National-Teams/Belgium/BelgiumAwayFrontSmall.png";
import belgiumBackSmall from "../leauges-asset/National-Teams/Belgium/BelgiumAwayBackSmall.png";
import "../../Pages/ShirtSales.css";

const BelgiumAway = () => {
  const [image, setImage] = useState(belgiumFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={belgiumFrontSmall}
          onClick={() => setImage(belgiumFront)}
          alt=""
        />
        <img
          src={belgiumBackSmall}
          onClick={() => setImage(belgiumBack)}
          alt=""
        />
      </div>
      <h1>BELGIUM AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={belgiumFront} alt="" />
          <img src={belgiumBack} alt="" />
        </div>
      </div>
    </div>
  );
