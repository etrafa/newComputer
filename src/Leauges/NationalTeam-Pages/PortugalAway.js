...
import portugalFront from "../leauges-asset/National-Teams/Portugal/PortugalAwayFront.png";
import portugalBack from "../leauges-asset/National-Teams/Portugal/PortugalAwayBack.png";
import portugalFrontSmall from "../leauges-asset/National-Teams/Portugal/PortugalAwayFrontSmall.png";
import portugalBackSmall from "../leauges-asset/National-Teams/Portugal/PortugalAwayBackSmall.png";
...
const PortugalAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>PORTUGAL AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
