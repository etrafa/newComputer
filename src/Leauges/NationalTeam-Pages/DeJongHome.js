...
import deJongFront from "../leauges-asset/National-Teams/Netherland-DeJong/deJongHomeFront.png";
import deJongBack from "../leauges-asset/National-Teams/Netherland-DeJong/deJongHomeBack.png";
import deJongFrontSmall from "../leauges-asset/National-Teams/Netherland-DeJong/deJongHomeFrontSmall.png";
import deJongBackSmall from "../leauges-asset/National-Teams/Netherland-DeJong/deJongHomeBackSmall.png";
...
const DeJongHome = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>NETHERLANDS HOME FRENKIE DE JONG FOOTBALL SHIRT 20/21</h1>
      <hr />
