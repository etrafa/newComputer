...
import ronaldoFront from "../leauges-asset/National-Teams/Portugal-Ronaldo/ronaldoAwayFront.png";
import ronaldoBack from "../leauges-asset/National-Teams/Portugal-Ronaldo/ronaldoAwayBack.png";
import ronaldoFrontSmall from "../leauges-asset/National-Teams/Portugal-Ronaldo/ronaldoAwayFrontSmall.png";
import ronaldoBackSmall from "../leauges-asset/National-Teams/Portugal-Ronaldo/ronaldoAwayBackSmall.png";
...
const RonaldoAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>PORTUGAL AWAY CRISTIANO RONALDO FOOTBALL SHIRT 20/21</h1>
      <hr />
