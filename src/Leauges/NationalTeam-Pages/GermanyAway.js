...
import germanyFront from "../leauges-asset/National-Teams/Germany/GermanyAwayFront.png";
import germanyBack from "../leauges-asset/National-Teams/Germany/GermanyAwayBack.png";
import germanyFrontSmall from "../leauges-asset/National-Teams/Germany/GermanyAwayFrontSmall.png";
import germanyBackSmall from "../leauges-asset/National-Teams/Germany/GermanyAwayBackSmall.png";
...
const GermanyAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>GERMANY AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
