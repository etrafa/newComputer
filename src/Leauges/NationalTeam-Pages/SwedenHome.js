...
import swedenFront from "../leauges-asset/National-Teams/Sweden/SwedenHomeFront.png";
import swedenBack from "../leauges-asset/National-Teams/Sweden/SwedenHomeBack.png";
import swedenFrontSmall from "../leauges-asset/National-Teams/Sweden/SwedenHomeFrontSmall.png";
import swedenBackSmall from "../leauges-asset/National-Teams/Sweden/SwedenHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const SwedenHome = () => {
  const [image, setImage] = useState(swedenFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={swedenFrontSmall}
          onClick={() => setImage(swedenFront)}
          alt=""
        />
        <img
          src={swedenBackSmall}
          onClick={() => setImage(swedenBack)}
          alt=""
        />
      </div>
      <h1>SWEDEN HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={swedenFront} alt="" />
          <img src={swedenBack} alt="" />
        </div>
      </div>
    </div>
  );
