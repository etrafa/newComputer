...
import mbappeFront from "../leauges-asset/National-Teams/France-Mbappe/mbappeHomeFront.png";
import mbappeBack from "../leauges-asset/National-Teams/France-Mbappe/mbappeHomeBack.png";
import mbappeFrontSmall from "../leauges-asset/National-Teams/France-Mbappe/mbappeHomeFrontSmall.png";
import mbappeBackSmall from "../leauges-asset/National-Teams/France-Mbappe/mbappeHomeBackSmall.png";
...
const MbappeHome = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>FRANCE HOME KYLIAN MBAPPÉ FOOTBALL SHIRT 20/21</h1>
      <hr />
