...
import griezmannFront from "../leauges-asset/National-Teams/France-Griezmann/griezmannAwayFront.png";
import griezmannBack from "../leauges-asset/National-Teams/France-Griezmann/griezmannAwayBack.png";
import griezmannFrontSmall from "../leauges-asset/National-Teams/France-Griezmann/griezmannAwayFrontSmall.png";
import griezmannBackSmall from "../leauges-asset/National-Teams/France-Griezmann/griezmannAwayBackSmall.png";
...
const GriezmannAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>FRANCE AWAY ANTOINE GRIEZMANN FOOTBALL SHIRT 20/21</h1>
      <hr />
