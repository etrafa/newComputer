...
import swedenFront from "../leauges-asset/National-Teams/Sweden/SwedenAwayFront.png";
import swedenBack from "../leauges-asset/National-Teams/Sweden/SwedenAwayBack.png";
import swedenFrontSmall from "../leauges-asset/National-Teams/Sweden/SwedenAwayFrontSmall.png";
import swedenBackSmall from "../leauges-asset/National-Teams/Sweden/SwedenAwayBackSmall.png";
...
const SwedenAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>SWEDEN AWAY FOOTBALL SHIRT 20/21</h1>
      <hr />
