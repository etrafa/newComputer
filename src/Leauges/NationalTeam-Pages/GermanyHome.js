...
import germanyFront from "../leauges-asset/National-Teams/Germany/GermanyHomeFront.png";
import germanyBack from "../leauges-asset/National-Teams/Germany/GermanyHomeBack.png";
import germanyFrontSmall from "../leauges-asset/National-Teams/Germany/GermanyHomeFrontSmall.png";
import germanyBackSmall from "../leauges-asset/National-Teams/Germany/GermanyHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const GermanyHome = () => {
  const [image, setImage] = useState(germanyFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={germanyFrontSmall}
          onClick={() => setImage(germanyFront)}
          alt=""
        />
        <img
          src={germanyBackSmall}
          onClick={() => setImage(germanyBack)}
          alt=""
        />
      </div>
      <h1>GERMANY HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={germanyFront} alt="" />
          <img src={germanyBack} alt="" />
        </div>
      </div>
    </div>
  );
