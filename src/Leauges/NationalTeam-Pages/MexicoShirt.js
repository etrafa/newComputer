...
import mexicoFront from "../leauges-asset/National-Teams/Mexico/mexicoFront.png";
import mexicoBack from "../leauges-asset/National-Teams/Mexico/mexicoBack.png";
import mexicoFrontSmall from "../leauges-asset/National-Teams/Mexico/mexicoFrontSmall.png";
import mexicoBackSmall from "../leauges-asset/National-Teams/Mexico/mexicoBackSmall.png";
import "../../Pages/ShirtSales.css";

const MexicoShirt = () => {
  const [image, setImage] = useState(mexicoFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={mexicoFrontSmall}
          onClick={() => setImage(mexicoFront)}
          alt=""
        />
        <img
          src={mexicoBackSmall}
          onClick={() => setImage(mexicoBack)}
          alt=""
        />
      </div>
      <h1>MEXICO HOME FOOTBALL SHIRT 2021</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={mexicoFront} alt="" />
          <img src={mexicoBack} alt="" />
        </div>
      </div>
    </div>
  );
