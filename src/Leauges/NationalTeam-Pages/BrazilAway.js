...
import brazilAwayFront from "../leauges-asset/National-Teams/Brazil/brazilAway.jpg";
import brazilAwayFrontSmall from "../leauges-asset/National-Teams/Brazil/brazilAwaySmall.jpg";
import "../../Pages/ShirtSales.css";

const BrazilAway = () => {
  const [image, setImage] = useState(brazilAwayFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={brazilAwayFrontSmall}
          onClick={() => setImage(BrazilAway)}
          alt=""
        />
      </div>
      <h1>BRAZIL AWAY FOOTBALL SHIRT 2021</h1>
      <hr />
