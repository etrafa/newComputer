...
import ronaldoFront from "../leauges-asset/National-Teams/Portugal-Ronaldo/ronaldoHomeBackSmall.png";
import ronaldoBack from "../leauges-asset/National-Teams/Portugal-Ronaldo/ronaldoHomeBackSmall.png";
import ronaldoFrontSmall from "../leauges-asset/National-Teams/Portugal-Ronaldo/ronaldoHomeBackSmall.png";
import ronaldoBackSmall from "../leauges-asset/National-Teams/Portugal-Ronaldo/ronaldoHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const RonaldoHome = () => {
  const [image, setImage] = useState(ronaldoFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={ronaldoFrontSmall}
          onClick={() => setImage(ronaldoFront)}
          alt=""
        />
        <img
          src={ronaldoBackSmall}
          onClick={() => setImage(ronaldoBack)}
          alt=""
        />
      </div>
      <h1>PORTUGAL HOME CRISTIANO RONALDO FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={ronaldoFront} alt="" />
          <img src={ronaldoBack} alt="" />
        </div>
      </div>
    </div>
  );
