...
import deBruyneFront from "../leauges-asset/National-Teams/Belgium-DeBruyne/deBruyneAwayFront.png";
import deBruyneBack from "../leauges-asset/National-Teams/Belgium-DeBruyne/deBruyneAwayBack.png";
import deBruyneFrontSmall from "../leauges-asset/National-Teams/Belgium-DeBruyne/deBruyneAwayFrontSmall.png";
import deBruyneBackSmall from "../leauges-asset/National-Teams/Belgium-DeBruyne/deBruyneAwayBackSmall.png";
...
const DeBruyneAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>BELGIUM AWAY KEVIN DE BRUYNE FOOTBALL SHIRT 20/21</h1>
      <hr />
