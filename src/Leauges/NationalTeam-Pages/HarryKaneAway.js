...
import harryKaneFront from "../leauges-asset/National-Teams/England-HarryKane/harryKaneAwayFront.png";
import harryKaneBack from "../leauges-asset/National-Teams/England-HarryKane/harryKaneAwayBack.png";
import harryKaneFrontSmall from "../leauges-asset/National-Teams/England-HarryKane/harryKaneAwayFrontSmall.png";
import harryKaneBackSmall from "../leauges-asset/National-Teams/England-HarryKane/harryKaneAwayBackSmall.png";
...
const HarryKaneAway = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ENGLAND AWAY HARRY KANE FOOTBALL SHIRT 20/21</h1>
      <hr />
