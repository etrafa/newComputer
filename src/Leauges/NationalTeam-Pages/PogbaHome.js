...
import pogbaFront from "../leauges-asset/National-Teams/France-Pogba/pogbaHomeFront.png";
import pogbaBack from "../leauges-asset/National-Teams/France-Pogba/pogbaHomeBack.png";
import pogbaFrontSmall from "../leauges-asset/National-Teams/France-Pogba/pogbaHomeFrontSmall.png";
import pogbaBackSmall from "../leauges-asset/National-Teams/France-Pogba/pogbaHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const PogbaHome = () => {
  const [image, setImage] = useState(pogbaFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={pogbaFrontSmall}
          onClick={() => setImage(pogbaFront)}
          alt=""
        />
        <img src={pogbaBackSmall} onClick={() => setImage(pogbaBack)} alt="" />
      </div>
      <h1>FRANCE HOME PAUL POGBA FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={pogbaFront} alt="" />
          <img src={pogbaBack} alt="" />
        </div>
      </div>
    </div>
  );
