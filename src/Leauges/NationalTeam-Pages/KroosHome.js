...
import kroosFront from "../leauges-asset/National-Teams/Germany-Kroos/kroosHomeFront.png";
import kroosBack from "../leauges-asset/National-Teams/Germany-Kroos/kroosHomeBack.png";
import kroosFrontSmall from "../leauges-asset/National-Teams/Germany-Kroos/kroosHomeFrontSmall.png";
import kroosBackSmall from "../leauges-asset/National-Teams/Germany-Kroos/kroosHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const KroosHome = () => {
  const [image, setImage] = useState(kroosFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={kroosFrontSmall}
          onClick={() => setImage(kroosFront)}
          alt=""
        />
        <img src={kroosBackSmall} onClick={() => setImage(kroosBack)} alt="" />
      </div>
      <h1>GERMANY HOME TONI KROOS FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={kroosFront} alt="" />
          <img src={kroosBack} alt="" />
        </div>
      </div>
    </div>
  );
