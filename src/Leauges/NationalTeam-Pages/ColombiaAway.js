...
import colombiaFront from "../leauges-asset/National-Teams/Colombia/colombiaFront.png";
import colombiaBack from "../leauges-asset/National-Teams/Colombia/colombiaBack.png";
import colombiaFrontSmall from "../leauges-asset/National-Teams/Colombia/colombiaFrontSmall.png";
import colombiaBackSmall from "../leauges-asset/National-Teams/Colombia/colombiaBackSmall.png";
import "../../Pages/ShirtSales.css";

const ColombiaAway = () => {
  const [image, setImage] = useState(colombiaFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={colombiaFrontSmall}
          onClick={() => setImage(colombiaFront)}
          alt=""
        />
        <img
          src={colombiaBackSmall}
          onClick={() => setImage(colombiaBack)}
          alt=""
        />
      </div>
      <h1>COLOMBIA AWAY FOOTBALL SHIRT 2021</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={colombiaFront} alt="" />
          <img src={colombiaBack} alt="" />
        </div>
      </div>
    </div>
  );
