...
import argentinaFront from "../leauges-asset/National-Teams/Argentina/argentinaHome.jpg";
import argentinaFrontSmall from "../leauges-asset/National-Teams/Argentina/argentinaHomeSmall.jpg";
...
const ArgentinaHome = () => {
  ...
  return (
    <div className="shirtSales__container">
      ...
      <h1>ARGENTINA HOME FOOTBALL SHIRT 2021</h1>
      <hr />
