...
import englandFront from "../leauges-asset/National-Teams/England/EnglandHomeFront.png";
import englandBack from "../leauges-asset/National-Teams/England/EnglandHomeBack.png";
import englandFrontSmall from "../leauges-asset/National-Teams/England/EnglandHomeFrontSmall.png";
import englandBackSmall from "../leauges-asset/National-Teams/England/EnglandHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const EnglandHome = () => {
  const [image, setImage] = useState(englandFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={englandFrontSmall}
          onClick={() => setImage(englandFront)}
          alt=""
        />
        <img
          src={englandBackSmall}
          onClick={() => setImage(englandBack)}
          alt=""
        />
      </div>
      <h1>ENGLAND HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={englandFront} alt="" />
          <img src={englandBack} alt="" />
        </div>
      </div>
    </div>
  );
