...
import modricFront from "../leauges-asset/National-Teams/Croatia-Modric/modricHomeFront.png";
import modricBack from "../leauges-asset/National-Teams/Croatia-Modric/modricHomeBack.png";
import modricFrontSmall from "../leauges-asset/National-Teams/Croatia-Modric/modricHomeFrontSmall.png";
import modricBackSmall from "../leauges-asset/National-Teams/Croatia-Modric/modricHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const ModricHome = () => {
  const [image, setImage] = useState(modricFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={modricFrontSmall}
          onClick={() => setImage(modricFront)}
          alt=""
        />
        <img
          src={modricBackSmall}
          onClick={() => setImage(modricBack)}
          alt=""
        />
      </div>
      <h1>CROATIA HOME LUKA MODRIĆ FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={modricFront} alt="" />
          <img src={modricBack} alt="" />
        </div>
      </div>
    </div>
  );
