...
import portugalFront from "../leauges-asset/National-Teams/Portugal/PortugalHomeFront.png";
import portugalBack from "../leauges-asset/National-Teams/Portugal/PortugalHomeBack.png";
import portugalFrontSmall from "../leauges-asset/National-Teams/Portugal/PortugalHomeFrontSmall.png";
import portugalBackSmall from "../leauges-asset/National-Teams/Portugal/PortugalHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const PortugalHome = () => {
  const [image, setImage] = useState(portugalFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={portugalFrontSmall}
          onClick={() => setImage(portugalFront)}
          alt=""
        />
        <img
          src={portugalBackSmall}
          onClick={() => setImage(portugalBack)}
          alt=""
        />
      </div>
      <h1>PORTUGAL HOME FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={portugalFront} alt="" />
          <img src={portugalBack} alt="" />
        </div>
      </div>
    </div>
  );
