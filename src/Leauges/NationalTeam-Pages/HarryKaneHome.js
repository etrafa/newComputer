...
import harryKaneFront from "../leauges-asset/National-Teams/England-HarryKane/harryKaneHomeFront.png";
import harryKaneBack from "../leauges-asset/National-Teams/England-HarryKane/harryKaneHomeBack.png";
import harryKaneFrontSmall from "../leauges-asset/National-Teams/England-HarryKane/harryKaneHomeFrontSmall.png";
import harryKaneBackSmall from "../leauges-asset/National-Teams/England-HarryKane/harryKaneHomeBackSmall.png";
import "../../Pages/ShirtSales.css";

const HarryKaneHome = () => {
  const [image, setImage] = useState(harryKaneFront);
  ...
  return (
    <div className="shirtSales__container">
      ...
      <div className="mainShirt__small">
        <img
          src={harryKaneFrontSmall}
          onClick={() => setImage(harryKaneFront)}
          alt=""
        />
        <img
          src={harryKaneBackSmall}
          onClick={() => setImage(harryKaneBack)}
          alt=""
        />
      </div>
      <h1>ENGLAND HOME HARRY KANE FOOTBALL SHIRT 20/21</h1>
      <hr />
      ...
      <div className="thirt__description">
        ...
        <div className="tshirt__features">
          ...
          <img src={harryKaneFront} alt="" />
          <img src={harryKaneBack} alt="" />
        </div>
      </div>
    </div>
  );
